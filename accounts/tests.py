...
class FormValidationTestCase(TestCase):
    ...
    def test_username_length_validation_login(self):
        ...
        # Note: form.is_valid() might fail due to authentication, but username
        # field should not have length errors
        form.full_clean()
        self.assertNotIn(
            'username',
            form.errors,
            "25-character username should not have length validation errors")
