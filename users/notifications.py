...
class NotificationService:
    ...
    def create_build_like_notification(build, liker):
        ...
        message = f"{liker.profile.get_display_name()} liked your build '{build.title}'"
    ...
    def create_build_comment_notification(build, commenter, comment):
        ...
        message = f"{commenter.profile.get_display_name()} commented on your build '{build.title}'"
    ...
    def create_comment_vote_notification(comment, voter, vote_type):
        ...
        message = f"{voter.profile.get_display_name()} upvoted your comment on '{comment.build.title}'"
