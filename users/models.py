...
class UserProfile(models.Model):
    ...
    favorite_weapon = models.CharField(
        max_length=100,
        blank=True,
        help_text="Your favorite Elden Ring weapon")

    # Notification preferences
    notify_on_build_like = models.BooleanField(
        default=True, help_text="Receive notifications when someone likes your build")
    notify_on_build_comment = models.BooleanField(
        default=True,
        help_text="Receive notifications when someone comments on your build")
    notify_on_comment_reply = models.BooleanField(
        default=True,
        help_text="Receive notifications when someone replies to your comment")
    notify_on_comment_vote = models.BooleanField(
        default=False,
        help_text="Receive notifications when someone votes on your comment")
    ...
    def get_profile_picture_url(self):
        ...
        if self.profile_picture and hasattr(self.profile_picture, 'url'):
            ...
            # Return a default avatar using a service like Gravatar or a
            # placeholder
            import hashlib
    ...
    def get_profile_picture_url(self, size='medium'):
        ...
        if self.profile_picture:
            ...
            return get_profile_picture_url(
                self.profile_picture, size_config['width'])
        else:
            ...
            return f"https://ui-avatars.com/api/?name={
                self.get_display_name()}&background=6c757d&color=ffffff&size={size_px}"
